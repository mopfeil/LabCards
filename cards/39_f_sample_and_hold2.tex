	\begin{tikzpicture}
		\cardbackground{images/sample_and_hold2.png}{0mm}
		\cardtypeCircuit
		\cardtitle{Sample and Hold}
		\cardcontent{\fontsize{9}{10}\selectfont A sample and hold circuit is used to sample a voltage, and retain it for some period of time. This is particularly useful in digital applications where a stable voltage is required in order to take accurate measurements (e.g. ADC).
		}
