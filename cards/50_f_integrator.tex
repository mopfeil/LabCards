	\begin{tikzpicture}
		\cardbackground{images/integrator.png}{0mm}
		\cardtypeOPV
		\cardtitle{integrator}
		\cardcontent{An Opamp Integrator performs the mathematical operation of integration on its input signal - that is, its output voltage is proportional to the input voltage over time.
		}
