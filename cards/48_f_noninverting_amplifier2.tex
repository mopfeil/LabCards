	\begin{tikzpicture}
		\cardbackground{images/noninverting_amplifier2.png}{0mm}
		\cardtypeOPV
		\cardtitle{noninverting amplifier}
		\cardcontent{Along with the inverting amplifier, the noninverting amplifier is one of the simplest opamp configurations. It amplifies the signal by a fixed gain.
		}
